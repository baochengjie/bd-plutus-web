...
@Component({
  selector: 'app-table-show-stat-coupon-month',
  templateUrl: './table-show-stat-coupon-month.component.html',
  styleUrls: ['./table-show-stat-coupon-month.component.css'],
  providers: [DatePipe]
})
export class TableShowStatCouponMonthComponent implements OnInit {

  dataUrl =  'http://localhost:8080/stat_coupon_month';
  dataSet: Array<any> = [];
  _allChecked = false;
