...
@Component({
  selector: 'app-table-show-stat-batch',
  templateUrl: './table-show-stat-batch.component.html',
  styleUrls: ['./table-show-stat-batch.component.css']
})
export class TableShowStatBatchComponent implements OnInit {
