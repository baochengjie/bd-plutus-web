...
@Component({
  selector: 'app-table-show-stat-finance-balance',
  templateUrl: './table-show-stat-finance-balance.component.html',
  styleUrls: ['./table-show-stat-finance-balance.component.css']
})
export class TableShowStatFinanceBalanceComponent implements OnInit {
  dataUrl_param = 'http://localhost:8080/stat_finance_and_taxi_balance_param';
  dataUrl = 'http://localhost:8080/stat_finance_and_taxi_balance';
  dataSet: Array<any> = [];
  _allChecked = false;
