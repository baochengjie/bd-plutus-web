...
@Component({
  selector: 'app-table-show-stat-finance-mall-pay-channel',
  templateUrl: './table-show-stat-finance-mall-pay-channel.component.html',
  styleUrls: ['./table-show-stat-finance-mall-pay-channel.component.css']
})
export class TableShowStatFinanceMallPayChannelComponent implements OnInit {

  dataUrl_param = 'http://localhost:8080/stat_finance_mall_pay_channel_param';
  dataUrl = 'http://localhost:8080/stat_finance_mall_pay_channel';
  dataSet: Array<any> = [];
  _allChecked = false;
