...
@Component({
  selector: 'app-table-show-stat-finance-withdraw',
  templateUrl: './table-show-stat-finance-withdraw.component.html',
  styleUrls: ['./table-show-stat-finance-withdraw.component.css']
})
export class TableShowStatFinanceWithdrawComponent implements OnInit {
  dataUrl_param = 'http://localhost:8080/stat_finance_withdraw_param';
  dataUrl = 'http://localhost:8080/stat_finance_withdraw';
  dataSet: Array<any> = [];
  _allChecked = false;
