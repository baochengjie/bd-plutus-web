...
@Component({
  selector: 'app-table-show-stat-trip-income',
  templateUrl: './table-show-stat-trip-income.component.html',
  styleUrls: ['./table-show-stat-trip-income.component.css']
})
export class TableShowStatTripIncomeComponent implements OnInit {
  dataUrl_param = 'http://localhost:8080/stat_trip_finance_income_param';
  dataUrl = 'http://localhost:8080/stat_trip_finance_income';
  dataSet: Array<any> = [];
  _allChecked = false;
