...
@Component({
  selector: 'app-table-show-stat-all-channel-income',
  templateUrl: './table-show-stat-all-channel-income.component.html',
  styleUrls: ['./table-show-stat-all-channel-income.component.css']
})
export class TableShowStatAllChannelIncomeComponent implements OnInit {
  dataUrl_param = 'http://localhost:8080/stat_all_finance_pay_channel_param';
  dataUrl = 'http://localhost:8080/stat_all_finance_pay_channel';
  dataSet: Array<any> = [];
  _allChecked = false;
