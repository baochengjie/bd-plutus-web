...
@Component({
  selector: 'app-table-show-stat-taxi-finance-withdraw',
  templateUrl: './table-show-stat-taxi-finance-withdraw.component.html',
  styleUrls: ['./table-show-stat-taxi-finance-withdraw.component.css']
})
export class TableShowStatTaxiFinanceWithdrawComponent implements OnInit {
  dataUrl_param = 'http://localhost:8080/stat_taxi_finance_withdraw_param';
  dataUrl = 'http://localhost:8080/stat_taxi_finance_withdraw';
  dataSet: Array<any> = [];
  _allChecked = false;
