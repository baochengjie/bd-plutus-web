...
@Component({
  selector: 'app-table-show-stat-finance-actual-payout-income',
  templateUrl: './table-show-stat-finance-actual-payout-income.component.html',
  styleUrls: ['./table-show-stat-finance-actual-payout-income.component.css']
})
export class TableShowStatFinanceActualPayoutIncomeComponent implements OnInit {

  dataUrl_param = 'http://localhost:8080/stat_finance_actual_payout_income_param';
  dataUrl = 'http://localhost:8080/stat_finance_actual_payout_income';
  dataSet: Array<any> = [];
  _allChecked = false;
