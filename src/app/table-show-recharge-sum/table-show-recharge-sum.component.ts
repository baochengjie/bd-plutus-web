...
@Component({
  selector: 'app-table-show-recharge-sum',
  templateUrl: './table-show-recharge-sum.component.html',
  styleUrls: ['./table-show-recharge-sum.component.css'],
  providers: [DatePipe]
})
export class TableShowRechargeSumComponent implements OnInit {
  dataUrl =  'http://localhost:8080/stat_recharge_month';
  dataSet: Array<any> = [];
