...
@Component({
  selector: 'app-table-show-stat-mobike-finance-income',
  templateUrl: './table-show-stat-mobike-finance-income.component.html',
  styleUrls: ['./table-show-stat-mobike-finance-income.component.css']
})
export class TableShowStatMobikeFinanceIncomeComponent implements OnInit {

  dataUrl_param = 'http://localhost:8080/stat_mobike_finance_income_param';
  dataUrl = 'http://localhost:8080/stat_mobike_finance_income';
  dataSet: Array<any> = [];
  _allChecked = false;
