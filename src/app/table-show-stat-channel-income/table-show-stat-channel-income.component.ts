...
@Component({
  selector: 'app-table-show-stat-channel-income',
  templateUrl: './table-show-stat-channel-income.component.html',
  styleUrls: ['./table-show-stat-channel-income.component.css']
})
export class TableShowStatChannelIncomeComponent implements OnInit {
