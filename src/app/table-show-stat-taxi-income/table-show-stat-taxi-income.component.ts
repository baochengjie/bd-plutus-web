...
@Component({
  selector: 'app-table-show-stat-taxi-income',
  templateUrl: './table-show-stat-taxi-income.component.html',
  styleUrls: ['./table-show-stat-taxi-income.component.css']
})
export class TableShowStatTaxiIncomeComponent implements OnInit {
  dataUrl_param = 'http://localhost:8080/stat_taxi_finance_income_param';
  dataUrl = 'http://localhost:8080/stat_taxi_finance_income';
  dataSet: Array<any> = [];
  _allChecked = false;
